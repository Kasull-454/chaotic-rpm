...
The repository's name is inspired by [Chaotic-AUR](https://aur.chaotic.cx/) for Arch Linux, and it was created simply because, since I already have the `.spec` files flagged for x86-64-v4, it costs me nothing to build the v3 versions as well — at least until Fedora provides official v3 repositories.

---

For instructions, please refer to the original repository, [gh4rib/copr-linux-cachyos](https://github.com/gh4rib/copr-linux-cachyos).
