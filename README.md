...
> **NOTE:** This repository primarily hosts packages I compile for my own personal workflow. However, I am open to adding new packages **upon request** whenever possible.

The repository's name is inspired by [Chaotic-AUR](https://aur.chaotic.cx/) for Arch Linux, bringing a convenient pre-built package collection over to Fedora.
