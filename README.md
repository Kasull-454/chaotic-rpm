...
> Requires support for v3 line instructions: **AVX, AVX2, FMA, BMI1, BMI2, MOVBE, and LZCNT** (roughly Intel 4th Gen *Haswell* / AMD *Zen 1* CPUs and newer). If you are using older hardware (v1 or v2), please use the standard repositories. Alternatively, if your CPU supports the AVX-512 instruction set, you can use the v4 version (**[Chaotic-Blackbird](https://github.com/Kasull-454/chaotic-blackbird)**).
